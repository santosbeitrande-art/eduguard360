...
SMTP_PASS=SET_SMTP_PASSWORD
SMTP_FROM=EduGuard Verify AI <no-reply@${DOMAIN}>
PASSWORD_RECOVERY_FORMSUBMIT_ENDPOINT=https://formsubmit.co/ajax
PASSWORD_RECOVERY_FORMSUBMIT_RECIPIENT=
PASSWORD_RECOVERY_FORMSUBMIT_CC=true
PASSWORD_RECOVERY_FORMSUBMIT_ORIGIN=https://${DOMAIN}
PASSWORD_RECOVERY_FORMSUBMIT_REFERER=https://${DOMAIN}/public/login
PASSWORD_RESET_RETURN_TOKEN=false
PASSWORD_RESET_ALLOW_MANUAL_FALLBACK=false
