...
export const translations = {
  pt: {
    ...
    sistema: {
      ...
      selecionar_perfil_acesso: 'Selecionar perfil de acesso',
      ...
      pagamento_escola_obrigatorio: 'Período grátis da escola expirado. O diretor deve renovar a subscrição para reativar acesso de toda a escola.',
      pagamento_escola_plans: 'A escola tem 1 mês grátis. Após esse período, o diretor deve pagar um plano mensal, trimestral ou anual para todos voltarem a aceder.',
      pagamento_registado: 'Pagamento registado com sucesso. Pode concluir o cadastro.',
      trial_ativo_ate: 'Período grátis ativo até',
      ...
      pagamento_numero_obrigatorio: 'Informe o número de telefone para cobrança móvel.',
      telefone_pagamento: 'Número de telefone (M-Pesa/eMola)',
      pin_pagamento: 'PIN de confirmação do pagamento',
      pedido_pagamento_enviado: 'Pedido de pagamento enviado para',
      inserir_pin_confirmar: 'Insira o PIN para confirmar a cobrança automática.',
      confirmar_com_pin: 'Confirmar cobrança com PIN',
      pin_invalido: 'PIN inválido. Informe pelo menos 4 dígitos.',
      destino_pagamento: 'Destino',
      perfil_nao_autorizado: 'Este utilizador não tem autorização para o perfil de acesso selecionado.',
    },
    home: {
  ...
  en: {
    ...
    sistema: {
      ...
      selecionar_perfil_acesso: 'Select access profile',
      ...
      pagamento_escola_obrigatorio: 'The school free period has expired. The director must renew subscription to reactivate access for the whole school.',
      pagamento_escola_plans: 'School has 1 free month. After that, the director must pay a monthly, quarterly, or annual plan so everyone regains access.',
      pagamento_registado: 'Payment registered successfully. You can complete signup now.',
      trial_ativo_ate: 'Free period active until',
      billing_monthly: 'Monthly',
      billing_quarterly: 'Quarterly',
      billing_annual: 'Annual',
      btn_pagar_plano: 'Pay school plan',
      validade_ate: 'Valid until',
      pagamento_numero_obrigatorio: 'Enter a phone number for mobile charging.',
      telefone_pagamento: 'Phone number (M-Pesa/eMola)',
      pin_pagamento: 'Payment confirmation PIN',
      pedido_pagamento_enviado: 'Payment request sent to',
      inserir_pin_confirmar: 'Enter PIN to confirm automatic charge.',
      confirmar_com_pin: 'Confirm charge with PIN',
      pin_invalido: 'Invalid PIN. Enter at least 4 digits.',
      destino_pagamento: 'Destination',
      perfil_nao_autorizado: 'This user is not authorized for the selected access profile.',
    },
    home: {
