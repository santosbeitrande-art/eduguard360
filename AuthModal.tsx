...
import { CloseIcon, MailIcon, UserIcon } from './ui/Icons';
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 transform transition-all">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-500">
            ...
            <button
              ...
              className="ml-1 text-indigo-600 font-medium hover:text-indigo-700"
            >
